...
func (a *App) Run(ctx context.Context, args []string) error {
	...
	a.rootCmd.Flags().BoolVar(&validator.lowerCase, "lower-case", false, "validates if the value contains lower case unicode letters only")
	a.rootCmd.Flags().BoolVar(&validator.upperCase, "upper-case", false, "validates if the value contains upper case unicode letters only")
