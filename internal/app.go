...
func (a *App) Run(ctx context.Context, args []string) error {
	...
	a.rootCmd.Flags().BoolVar(&orchestrator.Validator.lowerCase, "lower-case", false, "validates that the value contains only lower case Unicode letters")
	a.rootCmd.Flags().BoolVar(&orchestrator.Validator.upperCase, "upper-case", false, "validates that the value contains only upper case Unicode letterss")
