...
func (a *App) Run(ctx context.Context, args []string) error {
	...
	a.rootCmd.Flags().BoolVar(&validator.lowerCase, "lower-case", false, "validates if the value contains only lower case unicode letters")
	a.rootCmd.Flags().BoolVar(&validator.upperCase, "upper-case", false, "validates if the value contains only upper case unicode letters")
